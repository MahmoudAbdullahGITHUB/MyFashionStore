...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUpButton = findViewById(R.id.signupBu);
        googleIcon = findViewById(R.id.google_image);
...
*/
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (account != null) {
            ...
            Toast.makeText(MainActivity.this, personName + "  " + email, Toast.LENGTH_SHORT).show();
            System.out.println(" 1 = " + givenName + " 1 = " + personId);
            if (user != null) {
